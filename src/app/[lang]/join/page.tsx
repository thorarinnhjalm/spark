      ...
      <main className="w-full max-w-xl flex flex-col items-center">
        ...
        <div className="mb-10 text-center">
          <div className="flex items-center justify-center gap-3 mb-3">
            <div className="bg-slate-900 h-16 w-16 flex items-center justify-center rounded-2xl shadow-sm overflow-hidden">
              <img src="/spark-icon.png" alt="" className="h-12 w-12 object-contain mix-blend-screen" />
            </div>
